                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Column(
                        children: [
                          ...
                          8.verticalSpace,
                          Text(
                            'الرياض، حي النرجس، شارع الملك فهد', // Placeholder - will be replaced with real data
                    ...
                    CustomTextField(
                      ...
                      titleText: l10n.newAddress,
                      hintText: l10n.enterNewAddress,
                    ),
                    20.verticalSpace,
                    // Info text
                    Container(
                    ...
                    // Update button
                    NormalCustomButton(
                      label: l10n.updateAddress,
                      onPressed: () async {
                        if (addressController.text.trim().isEmpty) {
                          ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(
                              content: Text(l10n.pleaseEnterAddress),
